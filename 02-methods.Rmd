...
periods between 7 AM and 8 PM when the system runs at a 6-minute headway. 
Timepoints within these period are considered "AM Peak" if occurring between
7 and 9 AM, or "PM Peak" between 4 and 6 PM.
...
From January through June 6, the system operated with a 5-minute TSP request threshold
due to an erroneous system configuration; these timepoints were discarded. After
August 12, the system switched to a 2-minute TSP threshold. During the summer,
the TSP system was configured as follows for this experiment:
...
[@koenker2001quantile] to estimate the effect of TSP on headway deviation at the
15th and 85th percentiles of the distribution. This is done with the `quantreg`
package for R [@quantreg; @R]